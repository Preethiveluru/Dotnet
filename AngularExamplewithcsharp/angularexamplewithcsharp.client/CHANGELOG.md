...
- Create Angular project with ng: `ng new angularexamplewithcsharp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularexamplewithcsharp.client.esproj`).
